...
class AdminChatPage extends StatefulWidget {
  final String userId;
  final String userRole; // "artist" or "visitor"

  const AdminChatPage({super.key, required this.userId, required this.userRole});
...
class _AdminChatPageState extends State<AdminChatPage> {
  ...
  Widget build(BuildContext context) {
    final titleName = widget.userRole[0].toUpperCase() + widget.userRole.substring(1);

    return Scaffold(
      appBar: AppBar(title: Text('Chat with $titleName')),
      body: Column(
        children: [
          Expanded(
