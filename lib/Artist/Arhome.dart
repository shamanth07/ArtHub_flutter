              ...
              child: ListView(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.pushNamed(context, '/artistLikes');
                    },
                  ),
                  const Divider(),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.pushNamed(context, '/applyEvent');
                    },
                  ),
                  const Divider(),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.pushNamed(context, '/applicationStatus');
                    },
                  ),
                  const Divider(),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.pushNamed(context, '/artistSettings');
                    },
                  ),
                  const Divider(),
                  ListTile(
